...
use Pfe\FournisseurBundle\Entity\Offre;
use Pfe\FournisseurBundle\Form\OffreType;
...
class OffreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PfeFournisseurBundle:Offre')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PfeFournisseurBundle:Offre')->find($id);
     ...
     * @Method("POST")
     * @Template("PfeFournisseurBundle:Offre:new.html.twig")
     */
     ...
     *
     * @Route("/{id}/update", name="offre_update")
     * @Method("POST")
     * @Template("PfeFournisseurBundle:Offre:edit.html.twig")
     */
